...
In this tutorial we will cover how to load and save data vocab links to a Personal Online Datastore (Pod) and display it on screen.  A slightly more sophisticated UI will also be used.

*What you will learn*

* How to read and write vocab URLs to a Pod
* How to embed vocab in a page
...
The vocab app follows the model of the previous vocab app but adds a few more features to the UI and allows vocab to be trained.  A demo and the source code can be found in the footnotes.

The data format used for storing a vocab in a file here is:

```html
    <#this> <http://rdfs.org/sioc/ns#content> "content" .
```

The predicate here is an HTTP URI that uses the [SIOC](http://rdfs.org/sioc/spec/) vocabulary.  In this case the content is an embeddable vocab URL (as a string).  This is fetched after login using the code:
...
The setVideo function simply embeds the vocab file in an iframe element after determining the width and height (for mobile optimization).  Note: that because of [CORS](https://en.wikipedia.org/wiki/Cross-origin_resource_sharing) not all vocab URLs are embeddable in an iframe.  For example with youtube vocabs they URL should take the form `/embed/<id>`.
...
<#this>
    ...
    <http://usefulinc.com/ns/doap#description> "A vocab Saving for the Solid platform" ;
    <http://usefulinc.com/ns/doap#download-page> <https://melvincarvalho.github.io/vocab/> ;
    <http://usefulinc.com/ns/doap#homepage> <https://melvincarvalho.github.io/vocab/> ;
    <http://usefulinc.com/ns/doap#license> "mit" ;
    <http://usefulinc.com/ns/doap#maintainer> <http://melvincarvalho.com/#me> ;
    <http://usefulinc.com/ns/doap#name> "vocab" ;
    <http://usefulinc.com/ns/doap#shortdesc> "A vocab App for the Solid platform" ;
    <http://usefulinc.com/ns/doap#shortname> "vocab" ;
    <http://www.w3.org/ns/solid/app#description> "A vocab App for the Solid platform" ;
    <http://www.w3.org/ns/solid/app#homepage> <https://melvincarvalho.github.io/vocab/> ;
    <http://www.w3.org/ns/solid/app#icon> <http://melvincarvalho.github.io/vocab/images/icon.png> ;
    <http://www.w3.org/ns/solid/app#name> "vocab" .
```
